      ...
      <section className="py-16 lg:py-24 bg-gradient-to-b from-blush-50/60 to-cream-100 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-2xl">
            ...
            {/* CTA */}
            <Link
              href="/prescription/questionnaire"
              className="inline-flex items-center gap-2 bg-blush-500 text-white px-8 py-4 rounded-full font-semibold text-sm hover:bg-blush-600 transition-all hover:-translate-y-0.5 shadow-sm"
            >
              Start Your Refill <ArrowRight size={16} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-warm-100/40 border-t border-warm-200/50">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <p className="text-xs text-warm-400 leading-relaxed">
            Prescription refills are for existing patients with a valid prior prescription. Not
            for controlled substances or emergency needs. For medical emergencies, call 10177 (EMS)
