          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              <textarea
                ...
                rows={20}
                className="w-full bg-white rounded-xl border border-warm-200 p-6 text-warm-700 placeholder:text-warm-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 resize-none font-mono"
              />
            </div>
          </div>
