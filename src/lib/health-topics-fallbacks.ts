...
// Fallback posts shown when Sanity has no content yet.
// Slugs here must also be returned by generateStaticParams in health-topics/[slug]/page.tsx.
export const fallbackPosts: SanityPost[] = [
  {
    _id: 'fb-1',
