        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <motion.div variants={item} className="md:col-span-7 lg:col-span-8">
              <ServiceCard service={featured[0]} large onClick={() => openModal(featured[0].title)} />
            </motion.div>
            
            <motion.div variants={item} className="md:col-span-5 lg:col-span-4">
              <ServiceCard service={regular[0]} onClick={() => openModal(regular[0].title)} />
            </motion.div>
            
            <motion.div variants={item} className="md:col-span-4 lg:col-span-4">
              <ServiceCard service={regular[1]} onClick={() => openModal(regular[1].title)} />
            </motion.div>
            
            <motion.div variants={item} className="md:col-span-8 lg:col-span-8">
              <ServiceCard service={featured[1]} large onClick={() => openModal(featured[1].title)} />
            </motion.div>
            
            <motion.div variants={item} className="md:col-span-6 lg:col-span-5">
              <ServiceCard service={regular[2]} onClick={() => openModal(regular[2].title)} />
            </motion.div>
            
            <motion.div variants={item} className="md:col-span-6 lg:col-span-7">
              <ServiceCard service={regular[3]} onClick={() => openModal(regular[3].title)} />
            </motion.div>
          </motion.div>
        </div>
      </section>
...
function ServiceCard({ service, large = false, onClick }: { service: typeof services[0]; large?: boolean; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className={`
        group w-full text-left relative overflow-hidden rounded-3xl bg-white border border-warm-200/60
        hover:border-warm-300 hover:shadow-xl transition-all duration-500 cursor-pointer
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="mt-6 flex items-center gap-2 text-primary-500 font-medium text-sm opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
